...
function SearchResultDatasets({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table, {
    ...
    const variables = daplaJsUtilities.getNestedObject(unitDataStructure, [GSIM.LOGICAL_RECORDS]).map(entry => entry[GSIM.INSTANCE_VARIABLES]);
    return /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table.Row, {
      ...
      return /*#__PURE__*/React__default['default'].createElement(semanticUiReact.List.Item, {
        key: id
      }, daplaJsUtilities.getLocalizedGsimObjectText(language, name), /*#__PURE__*/React__default['default'].createElement("br", null), /*#__PURE__*/React__default['default'].createElement("i", null, daplaJsUtilities.getLocalizedGsimObjectText(language, description)));
    })))));
  }))));
}
...
function SearchResultVariables({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, variableTypeFilter.length !== 3 && /*#__PURE__*/React__default['default'].createElement(FilterWarning, {
    ...
    if (type === GSIM.INSTANCE_VARIABLE) {
      inheritsFrom = daplaJsUtilities.getLocalizedGsimObjectText(language, values[GSIM.REPRESENTED_VARIABLE][GSIM.NAME]);
      inheritsFromType = GSIM.REPRESENTED_VARIABLE;
    }

    if (type === GSIM.REPRESENTED_VARIABLE) {
      inheritsFrom = daplaJsUtilities.getLocalizedGsimObjectText(language, values[GSIM.VARIABLE][GSIM.NAME]);
    ...
    return /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Segment, {
      ...
      width: 12
    }, daplaJsUtilities.getLocalizedGsimObjectText(language, description))), inheritsFrom && /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Grid.Row, null, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Grid.Column, {
      width: 4
    }, /*#__PURE__*/React__default['default'].createElement("b", null, RESULTS.INHERITS_FROM[language])), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Grid.Column, {
      width: 12
    }, `${inheritsFrom} (${inheritsFromType})`)))), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Grid.Column, null, /*#__PURE__*/React__default['default'].createElement(VariableInDatasetLookup, {
      id: id,
      type: type,
      language: language
    }))));
