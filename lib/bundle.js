...
function SearchResultDatasets({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table, {
    ...
    collapsing: true
  }), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table.HeaderCell, null, RESULTS.NAME[language]), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table.HeaderCell, null, RESULTS.DESCRIPTION[language]), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table.HeaderCell, null, RESULTS.DATA_SOURCE_PATH[language]), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table.HeaderCell, null))), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table.Body, null, datasets.map(dataset => {
...
const drillVariables = (data, type) => data.reduce((acc, cur) => {
  ...
  if (lineageFields && lineageFields.length !== 0) {
    lineageFields.forEach(lineageField => {
      ...
      if (smart.length !== 0) {
        const dataset = smart.filter(innerDataset => innerDataset[QUERY_HELPERS.LINEAGE_DATASET].hasOwnProperty(QUERY_HELPERS.REVERSE.UDS_L) && innerDataset[QUERY_HELPERS.LINEAGE_DATASET][QUERY_HELPERS.REVERSE.UDS_L].length !== 0);

        if (dataset.length !== 0) {
          dataset.forEach(innerDataset => {
            innerDataset[QUERY_HELPERS.LINEAGE_DATASET][QUERY_HELPERS.REVERSE.UDS_L].forEach(lineage => datasets.push(lineage));
          });
        }
      }
    });
...
function VariableInDatasetLookup({
  ...
  const panels = [{
    ...
    content: {
      ...
      }, retrievedDatasets.map(dataset => /*#__PURE__*/React__default['default'].createElement(semanticUiReact.List.Item, {
        key: dataset.id,
        as: "a"
