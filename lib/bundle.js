...
function SearchResultVariables({
  ...
  return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, variableTypeFilter.length !== 3 && /*#__PURE__*/React__default['default'].createElement(FilterWarning, {
    ...
    }, daplaJsUtilities.getLocalizedGsimObjectText(language, description))), /*#__PURE__*/React__default['default'].createElement(semanticUiReact.Table.Cell, null, searchMethod === API.SEARCH_METHODS[0] ? /*#__PURE__*/React__default['default'].createElement(VariableInDatasetFilterLookup, {
      id: id,
      type: type,
      language: language
